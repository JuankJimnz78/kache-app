...
class CategoriaDetalle {
  ...
  const CategoriaDetalle({required this.id, required this.nombre, required this.descripcion});
...
class Producto {
  ...
  factory Producto.fromJson(Map<String, dynamic> j) => Producto(
    ...
    categoriaDetalle: j['categoria_detalle'] != null
        ? CategoriaDetalle.fromJson(j['categoria_detalle'] as Map<String, dynamic>)
        : null,
  );
...
class PaginatedProductos {
  ...
  const PaginatedProductos({required this.count, required this.next, required this.results});

  factory PaginatedProductos.fromJson(Map<String, dynamic> j) => PaginatedProductos(
