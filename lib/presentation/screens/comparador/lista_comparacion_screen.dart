// lib/presentation/screens/comparador/lista_comparacion_screen.dart
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                const EncabezadoPreciosEC(titulo: 'Mis listas de compras'),
                        ...
                        children:
                          ...
                          final tipo = TipoComercio.fromValue(
                            itemsDeEsteComercio.isNotEmpty
                                ? itemsDeEsteComercio
                                    .first.comercioDetalle.tipo
                                : 'supermercado',
                          );
                          final tieneDelivery =
                              ComercioLinks.tieneDelivery(nombreComercio);
                          final urlMaps =
                              ComercioLinks.urlMaps(nombreComercio);
                                      ...
                                      if (tieneDelivery) ...[
                                        Expanded(
                                          child: ElevatedButton.icon(
                                            ...
                                            onPressed: () {
                                              final url =
                                                  ComercioLinks.urlDelivery(
                                                      nombreComercio,
                                                      nombresProductos);
                                              if (url != null) {
                                                _abrirUrl(url, context);
                                              }
                                            },
                                          ),
                                        ),
